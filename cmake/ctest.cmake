if (BUILD_TESTING)
	...
	## ui_uihelpdlg.h is generated by qt_wrap_ui for the application target, so
	## the test has to list it too or a parallel build may compile helpdlg.cpp
	## before it exists.
	add_executable(${TEST_HELP} MACOSX_BUNDLE tests/test_help.cpp src/helpdlg.cpp src/settings.cpp ${RES_SOURCES} ${UI_HEADERS})
	...
	add_executable(${TEST_METER} MACOSX_BUNDLE tests/test_meter.cpp src/meterwid.cpp)
