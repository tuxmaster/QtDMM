...
SimpleCfgGroup::SimpleCfgGroup( const QString & name ) :  groupName( name )
{
}
...
SimpleCfg::SimpleCfg( const QString & name ) : fname( name )
{
}
...
void SimpleCfg::setComment( const QString & comment )
{
  m_comment = comment;
}
