...
/// over the network (RFC2217SerialDevice) and sigrok-cli as a data source
/// (SigrokDevice). DMM only ever sees the QIODevice returned by port().
...
public:
    ...
    /// "serial", "hid", "sigrok" or "rfc2217" (case-insensitive) to PortType.
