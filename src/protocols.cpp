...
// { ReadEvent::<Id>, "<Name>", "<description>", "<chip>", make<...> }.
const std::vector<ProtocolInfo> &protocols()
{
  static const std::vector<ProtocolInfo> table = {
    ...
    { ReadEvent::Sigrok,                "Sigrok",                QT_TRANSLATE_NOOP("Protocols", "variable bytes ASCII, Sigrok"),                                "",                      make<DecoderAscii> },
    ...
    { ReadEvent::VictronBLE,            "VictronBLE",            QT_TRANSLATE_NOOP("Protocols", "Bluetooth LE advertisements, encrypted (Victron Instant Readout)"),  "",                 make<DecoderVictronBLE> },
  };
  return table;
}
