...
- Readings table: every value the meter sent, with time, mode and range; copy to a spreadsheet or export as CSV (see [Readings table](docs/user/readings-table.md))
